...
public final class SetSecondary1LTest {
    ...
    @Test
    public void testIsSubset_1() {
        Set<String> s1 = createFromArgs("2", "4");
        Set<String> s2 = createFromArgs("1", "2", "3", "4");
        boolean result = s1.isSubset(s2);
        assertEquals(true, result);
    }

    @Test
    public void testIsSubset_2() {
        Set<String> s1 = createFromArgs("3", "4", "5");
        Set<String> s2 = createFromArgs("1", "2", "3", "4");
        boolean result = s1.isSubset(s2);
