...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        // get rest of string except common string of str2.
        int leftIndex = overlap;
        int rightIndex = str2.length();
        String str2Remaind = str2.substring(leftIndex, rightIndex);

        String combineStr = str1 + str2Remaind;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        // check for it is not a substring of any string already in strSet
        ...
        if (shouldAdd) {
            // check for string already in strSet that is a substring of str
            Set<String> tempSet = strSet.newInstance();
            while (strSet.size() > 0) {
                String temp = strSet.removeAny();
            ...
            // transfer temp set into original set
            strSet.transferFrom(tempSet);
        }
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        while (!input.atEOS()) {
            ...
            if (!str.isBlank()) {
                ...
                addToSetAvoidingSubstrings(strSet, str);
            }
        }
