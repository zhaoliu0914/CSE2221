...
public final class MonteCarlo1 {
    ...
    public static void main(String[] args) {
        ...
        while (ptsInInterval < n) {
            ...
            // calculate the distance between point(x,y) and center(0.0, 0.0)
        ...
        double quarterCircle = estimate * areaOfSquare;
        double areaOfCircle = quarterCircle * totalCircle;
        //output.println("Estimate of percentage: " + estimate + "%");
        output.println("the area of a circle of radius 2: " + areaOfCircle);
