...
public final class AppendUndoView1 extends JFrame implements AppendUndoView {
     ...
     * Buttons.
     */
    private final JButton resetButton, appendButton, undoButton, redoButton;
    ...
    public AppendUndoView1() {
         ...
         */
        super("Simple Append/Undo GUI Demo With MVC");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.resetButton) {
            ...
            this.controller.processRedoEvent();
        }
        /*
    ...
    @Override
    public void updateRedoAllowed(boolean allowed) {
        this.redoButton.setEnabled(allowed);
    }
