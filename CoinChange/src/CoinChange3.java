...
public final class CoinChange3 {
     ...
     *
     * @param cents
     * @param unitConversionArray
     * @return an array of coin counts
     */
    public static int[] coinCountsToMakeChange(int cents,
            int[] unitConversionArray) {
    ...
    public static void main(String[] args) {
        ...
        // calculate how many dollar can be used.
        int[] changes = coinCountsToMakeChange(cents, unitConversionArray);
