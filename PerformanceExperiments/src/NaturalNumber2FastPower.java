 ...
 *
 */
public final class NaturalNumber2FastPower extends NaturalNumber2 {

    /**
     * No-argument constructor.
     */
    public NaturalNumber2FastPower() {
    }
     ...
     */
    public NaturalNumber2FastPower(int i) {
        super(i);
    }
     ...
     */
    public NaturalNumber2FastPower(String s) {
        super(s);
    }
     ...
     */
    public NaturalNumber2FastPower(NaturalNumber n) {
        super(n);
    }
    ...
    public static void main(String[] args) {
        ...
        NaturalNumber n = new NaturalNumber2FastPower(input);
