...
public final class PizzaOrderManager {
    ...
    private static void getPriceMap(String fileName,
        ...
        while (!in.atEOS()) {
            ...
            if (index != -1) {
                ...
                String priceStr = line.substring(index + 1);
    ...
    private static int getOneOrder(SimpleReader input,
        ...
        while (!line.isBlank()) {
            ...
            if (totalPrice == 0) {
                ...
                price = sizePriceMap.value(line);
            } else {
                price = toppingPriceMap.value(line);
            }
    ...
    private static void putPrice(SimpleWriter output, int price) {
        ...
        String dollars = priceStr.substring(0, size - 2);
        String cents = priceStr.substring(size - 2, size);

        output.println(dollars + "." + cents);
    }
