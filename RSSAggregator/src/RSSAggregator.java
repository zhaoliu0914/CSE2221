...
/**
 * ask the user for the name of an XML file containing a list of URLs for RSS
 * v2.0 feeds and for the name of an output file in which to generate an HTML
...
public final class RSSAggregator {
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        SimpleWriter fileWriter = new SimpleWriter1L(file);
    ...
    public static void main(String[] args) {
        ...
        // get XML file and the name of index HTML from user.
        out.print("Please entere XML file: ");
        String xmlFile = in.nextLine();

        out.print(
                "Please entere the name of HTML file including .html extension: ");
        ...
        int numberOfFeed = feeds.numberOfChildren();
        for (int i = 0; i < numberOfFeed; i++) {
            ...
            XMLTree feedXMLTree = new XMLTree1(url);
            String rootLabel = feedXMLTree.label();
            // checking for version attribute.
            String version = "";
            boolean hasVersionAtt = feedXMLTree.hasAttribute("version");
            if (hasVersionAtt) {
                version = feedXMLTree.attributeValue("version");
            }
            ...
            if (expectedRootLabel.equals(rootLabel)
                ...
                //<li><a href="nasa.html">NASA Breaking News</a></li>
                fileWriter.println(
                        "<li><a href=\"" + file + "\">" + name + "</a></li>");

            } else {
                out.println(url + " is not a valid RSS 2.0 feed!");
            }
