...
public final class NaturalNumberStaticOps {
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        NaturalNumber remainder = n.divide(ONE_THOUSAND);

        String remainderStr = remainder.toString();
        while (remainderStr.length() <= 2) {
            remainderStr = "0" + remainderStr;
        }

        printWithCommas(n, out);

        out.print("," + remainderStr);

        for (int i = 0; i < remainderStr.length(); i++) {
            char charInt = remainderStr.charAt(i);
            n.multiplyBy10(Character.getNumericValue(charInt));
        }
    }
    ...
    public static String toStringWithCommas(NaturalNumber n) {
        ...
        String remainderWithCommas = toStringWithCommas(n);
        ...
        return remainderWithCommas + "," + remainderStr;
    }
